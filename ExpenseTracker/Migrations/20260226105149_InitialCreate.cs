        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Drafts_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovedItems_Requests_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinanceStatuses_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RejectedItems_Employees_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RejectedItems_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovedItems_RequestId",
                table: "ApprovedItems",
                column: "RequestId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinanceStatuses_RequestId",
                table: "FinanceStatuses",
                column: "RequestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RejectedItems_ManagerId",
                table: "RejectedItems",
                column: "ManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_RejectedItems_RequestId",
                table: "RejectedItems",
                column: "RequestId",
                unique: true);
